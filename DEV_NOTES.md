...
multipass transfer D:\Projects\helm-charts\charts\aspnetcore-ignite-server microk8s-vm:helms/aspnetcore-ignite-server -r
microk8s helm install aspnetcore-ignite-server ./helms/aspnetcore-ignite-server -n ra2
...
multipass exec microk8s-vm -- rm -rf helms/aspnetcore-ignite-server

multipass transfer D:\Projects\helm-charts\charts\clamav-openshift microk8s-vm:helms/clamav-openshift -r
microk8s helm install clamav-openshift ./helms/clamav-openshift -n ra2
microk8s kubectl port-forward -n ra2 service/clamav-openshift 3310:3310
microk8s helm uninstall clamav-openshift -n ra2
multipass exec microk8s-vm -- rm -rf helms/clamav-openshift
